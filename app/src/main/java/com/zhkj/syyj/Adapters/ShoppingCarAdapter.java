...
public class ShoppingCarAdapter extends BaseExpandableListAdapter {
        ...
        btnOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (temp != null && temp.size() > 0) {//如果有被选中的
                     ...
                     * 则跳转到确认订单页面，完成后续订单流程。
                     */
                    ToastUtils.showToast(context, "跳转到确认订单页面，完成后续订单流程");
                } else {
                    ToastUtils.showToast(context, "请选择要购买的商品");
                }
            }
        });
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (childPosition==(datasBean.getGoods().size()-1)){
            childViewHolder.view_bottom_rl.setVisibility(View.VISIBLE);
        }else {
            childViewHolder.view_bottom_rl.setVisibility(View.GONE);
        }
        ...
        childViewHolder.ivEditSubtract.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (integer > 1) {
                    ...
                    ToastUtils.showToast(context, "商品不能再减少了");
                }
                notifyDataSetChanged();
            }
        });
